...
A implementação foi realizada em Python 3.8+, utilizando o framework PyTorch 2.0 para construção e treinamento das redes neurais, e PyWavelets 1.4.1 para aplicação da decomposição wavelet multinível nas imagens. A reprodutibilidade é garantida pela disponibilização do código-fonte em repositório público no GitHub\footnote{\url{https://github.com/jessicac13/tcc}}

, permitindo que os experimentos possam ser replicados por outros pesquisadores.
